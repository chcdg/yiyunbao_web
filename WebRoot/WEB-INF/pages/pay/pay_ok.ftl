...
<div class="wrap">
  <div class="mainLogin">
    ...
    <!--头部结束-->
    <!--注册导航开始-->
    <div class="change size20 yahei"> <span class="a" style="width:100%">恭喜您，充值${pay.pay_money!""}元成功！</span></div>
    <!--注册导航结束-->
    <!--注册表单开始-->
    <div class="regFrom"> 
    <form id="form1" method="post" >
      ...
      <span> <font class="yahei size18 black3 left">支付方式：</font>
      	<#if pay.pay_platform == 1>
      	<img src="/images/pay/yibao.jpg"/>
      	<#else>
      	<img src="/images/pay/alipay.gif"/>
      	</#if>
      </span> 
      <span><a href="/main" class="button">进入我的易运宝</a></span>
    </form>  
      </div>
    <!--注册表单结束-->
