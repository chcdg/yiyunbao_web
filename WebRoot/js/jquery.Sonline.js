...
(function($){
	...
	$.fn.Sonline.splitStr = function(opts){
		...
		for (var i=0;i<strs.length;i++){	
			...
			QqHtml = QqHtml+"<div class='QQList'><span>"+subStrs[1]+"：</span><br><a target='_blank' href='http://wpa.qq.com/msgrd?v=3&uin="+subStrs[0]+"&site=qq&menu=yes'><img border='0' src='/images/qq.jpg' alt='点击这里'></a></div><div style='clear:both'></div>"
		}
		return QqHtml;
	}
})(jQuery);    
