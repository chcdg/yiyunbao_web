...
public class JSONUtils {
	 ...
	 * @author shevliu
	 * @email shevliu@gmail.com Mar 17, 2013 3:42:13 PM
	 * @param page
	 *            record
	 * @param attributes
	 * @return
	...
	public static String toPagedGridJSONStringUsingRecord(Page<Record> page) {
		...
		try {
			...
			for (Record record : page.getList()) {
				JSONObject obj = new JSONObject();
				for (Iterator it = record.getColumns().keySet().iterator(); it
						.hasNext();) {
	 ...
	 * @author shevliu
	 * @email shevliu@gmail.com Mar 15, 2013 9:32:47 PM
	 * @param list
	 * @param attributes
	 */
	public static String toJSONString(List<? extends Model> list,
			String attributes) {
		try {
			List<String> attrList = WuliuStringUtils.parseVertical(attributes);
	...
	public static String toJSONStringUsingRecord(List<Record> list,
			String attributes) {
		try {
			List<String> attrList = WuliuStringUtils.parseVertical(attributes);
	...
	public static String toJson(Object obj, boolean success) {
